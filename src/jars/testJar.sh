java -jar asg1jarfile.jar ../inputs/input1.txt output.txt
java -jar asg1jarfile.jar ../inputs/input2.txt output.txt
java -jar asg1jarfile.jar ../inputs/input3.txt output.txt
java -jar asg1jarfile.jar ../inputs/input4.txt output.txt
java -jar asg1jarfile.jar ../inputs/input5.txt output.txt
java -jar asg1jarfile.jar ../inputs/input6.txt output.txt
java -jar asg1jarfile.jar ../inputs/input7.txt output.txt
java -jar asg1jarfile.jar ../inputs/input8.txt output.txt
java -jar asg1jarfile.jar ../inputs/input9.txt output.txt
